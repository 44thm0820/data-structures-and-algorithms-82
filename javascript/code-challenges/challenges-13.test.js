...
const { isComment } = require("domhandler");
...
const longestString = (arr) => {
  ...
  let indexLongestString = 0; //0, 1, 1, 3, return this variable
  let longestLength = arr[0].length; // 5, 8, 4, 9
  ...
  // return arr.reduce((prev, curr, idx, array) => array[idx + 1].length > curr.length ? idx + 1 : idx, -1);
