...
const addOne = (arr) => {
  // Solution code here...
  let arrNew = [];
  arr.forEach(num => arrNew.push(num + 1));
  return arrNew;
};
...
const addExclamation = (arr) => {
  // Solution code here...
  let arrNew = [];
  arr.forEach(str => arrNew.push(str + '!'));
  return arrNew;
};
...
const allUpperCase = (arr) => {
  // Solution code here...
  let arrNew = [];
  arr.forEach(str => arrNew.push(str.toUpperCase()));
  return arrNew;
};
...
const speaker = (words, callback) => {
  // Solution code here...
  let wordsNew = [];
  words.forEach(word => wordsNew.push(callback(word)));
  return wordsNew;
};
...
const createList = (availableItems) => {
  // Solution code here...
  let arr = [];
  availableItems.forEach(fruitItem => fruitItem.available ? arr.push(fruitItem.name) : null);
  return arr;
};
