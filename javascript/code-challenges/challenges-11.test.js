...
const totalSum = (input) => {
  // Solution code here...
  return input.reduce((prevOuter, arr) => prevOuter + arr.reduce((prevInner, int) => prevInner + int, 0), 0);
};
...
let findShortest = (data) => {
  // Solution code here...
  return data.reduce((prevCharacter, currCharacter) => Number(prevCharacter.height) > Number(currCharacter.height) ? currCharacter : prevCharacter).name;
};
/* ------------------------------------------------------------------------------------------------
TESTS
